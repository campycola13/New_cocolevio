...
export default function Card() {
  ...
  return (
    <div className="bg-white rounded-2xl md:rounded-3xl h-90 md:h-120 p-4 md:p-6 shadow-sm">
      <h3 className="text-base md:text-xl font-semibold mb-4 md:mb-6 text-gray-800">Project Progress</h3>
